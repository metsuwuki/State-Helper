...
StateHelper/Rodina_factions/license_center/commands.lua
]]
local commands = {
--> Приветствие
[1] = [[
...
[2] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {priceauto1} руб., на 2 месяца {priceauto2} руб., на 3 месяца {priceauto3}$"
    ],
    [
      "SEND",
...
[3] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {pricegun1} руб., на 2 месяца {pricegun2} руб., на 3 месяца {pricegun3}$"
    ],
    [
      "SEND",
      "На какой срок оформляем?"
...
[5] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {pricefish1} руб., на 2 месяца {pricefish2} руб., на 3 месяца {pricefish3}$"
    ],
    [
      "SEND",
      "На какой срок оформляем?"
...
[6] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {pricemoto1} руб., на 2 месяца {pricemoto2} руб., на 3 месяца {pricemoto3}$"
    ],
    [
      "SEND",
      "На какой срок оформляем?"
...
[7] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {pricemeh1} руб., на 2 месяца {pricemeh2} руб., на 3 месяца {pricemeh3}$"
    ],
    [
      "SEND",
      "На какой срок оформляем?"
...
[8] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {pricetaxi1} руб., на 2 месяца {pricetaxi2} руб., на 3 месяца {pricetaxi3}$"
    ],
    [
      "SEND",
      "На какой срок оформляем?"
...
[9] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {priceswim1} руб., на 2 месяца {priceswim2} руб., на 3 месяца {priceswim3}$"
    ],
    [
      "SEND",
      "На какой срок оформляем?"
...
[10] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {pricehunt1} руб., на 2 месяца {pricehunt2} руб., на 3 месяца {pricehunt3}$"
    ],
    [
      "SEND",
      "На какой срок оформляем?"
...
[11] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "На 1 месяц {priceexc1} руб., на 2 месяца {priceexc2} руб., на 3 месяца {priceexc3}$"
    ],
    [
      "SEND",
      "На какой срок оформляем?"
...
[13] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "Водительские права 1 месяц {priceauto1} руб., 2 месяца {priceauto2} руб., 3 месяца {priceauto3}$"
    ],
    [
      "SEND",
      "Права на мото-транспорт 1 месяц {pricemoto1} руб., 2 месяца {pricemoto2} руб., 3 месяца {pricemoto3}$"
    ],
    [
      "SEND",
      "Права на водный транспорт 1 месяц {priceswim1} руб., 2 месяца {priceswim2} руб., 3 месяца {priceswim3}$"
    ],
    [
      "SEND",
      "Лицензия на рыбалку 1 месяц {pricefish1} руб., 2 месяца {pricefish2} руб., 3 месяца {pricefish3}$"
    ],
    [
      "SEND",
      "Лицензия на владение оружием 1 месяц {pricegun1} руб., 2 месяца {pricegun2} руб., 3 месяца {pricegun3}$"
    ],
    [
      "SEND",
      "Лицензия на охоту 1 месяц {pricehunt1} руб., 2 месяца {pricehunt2} руб., 3 месяца {pricehunt3}$"
    ],
    [
      "SEND",
      "Лицензия на раскопки 1 месяц {priceexc1} руб., 2 месяца {priceexc2} руб., 3 месяца {priceexc3}$"
    ],
    [
      "SEND",
      "Лицензия на работу в такси 1 месяц {pricetaxi1} руб., 2 месяца {pricetaxi2} руб., 3 месяца {pricetaxi3}$"
    ],
    [
      "SEND",
      "Лицензия на работу механика 1 месяц {pricemeh1} руб., 2 месяца {pricemeh2} руб., 3 месяца {pricemeh3}$"
    ],
    [
      "SEND",
...
[14] = [[
{
  ...
  "act": [
    ...
    [
      "SEND",
      "...вы получите штраф от сотрудников полиции."
    ],
    [
      "SEND",
