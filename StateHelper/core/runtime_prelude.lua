...
local sh_fonts_dir = sh_legacy_data_path('������')
local sh_images_dir = sh_legacy_data_path('�����������')
local sh_tsr_dir = sh_legacy_data_path('TSR')
local sh_roleplay_dir = sh_legacy_data_path('���������')
...
function download_font()
	...
	if not doesFileExist(sh_legacy_data_path('������', 'SF600.ttf')) or not doesFileExist(sh_legacy_data_path('������', 'SF800.ttf')) then
		download_id = downloadUrlToFile(link_meduim_font, sh_legacy_data_path('������', 'SF600.ttf'), function(id, status, p1, p2)
			if status == dlstatus.STATUS_ENDDOWNLOADDATA then
				inst_suc_font[1] = true
			end
		end)
		download_id = downloadUrlToFile(link_bold_font, sh_legacy_data_path('������', 'SF800.ttf'), function(id, status, p1, p2)
			if status == dlstatus.STATUS_ENDDOWNLOADDATA then
...
if not doesFileExist(sh_legacy_data_path('�����������', 'logo update.png')) then
	download_id = downloadUrlToFile(sh_project_remote_data_url('assets/images/logo update.png'), sh_legacy_data_path('�����������', 'logo update.png'), function(id, status, p1, p2)
		if status == dlstatus.STATUS_ENDDOWNLOADDATA then
...
function download_image()
	...
	if not doesFileExist(sh_legacy_data_path('�����������', 'No label.png')) then
		download_id = downloadUrlToFile(sh_project_remote_data_url('assets/images/No label.png'), sh_legacy_data_path('�����������', 'No label.png'), function(id, status, p1, p2)
			if status == dlstatus.STATUS_ENDDOWNLOADDATA then 
				--image_no_label = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'No label.png'))
			end
		end)
	end
	
	local function download_record_label(url_label_record, name_label, i_rec)
		if not doesFileExist(sh_legacy_data_path('�����������', name_label .. '.png')) then
			download_id = downloadUrlToFile(url_label_record, sh_legacy_data_path('�����������', name_label .. '.png'), function(id, status, p1, p2)
				if status == dlstatus.STATUS_ENDDOWNLOADDATA then 
					--image_record[i_rec] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', name_label .. '.png'))
				end
			end)
		end
	end
	...
	local function download_radio_label(url_label_radio, name_label, i_radio)
		if not doesFileExist(sh_legacy_data_path('�����������', name_label .. '.png')) then
			download_id = downloadUrlToFile(url_label_radio, sh_legacy_data_path('�����������', name_label .. '.png'), function(id, status, p1, p2)
				if status == dlstatus.STATUS_ENDDOWNLOADDATA then 
					--image_radio[i_radio] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', name_label .. '.png'))
				end
			end)
		end
	end
...
imgui.OnInitialize(function()
	...
	imgui.GetIO().Fonts:AddFontFromFileTTF(u8(sh_legacy_data_path('������', 'SF600.ttf')), 16.0, nil, glyph_ranges)
	
	font[1] = imgui.GetIO().Fonts:AddFontFromFileTTF(u8(sh_legacy_data_path('������', 'SF600.ttf')), 10.0, nil, glyph_ranges)
	font[2] = imgui.GetIO().Fonts:AddFontFromFileTTF(u8(sh_legacy_data_path('������', 'SF600.ttf')), 13.0, nil, glyph_ranges)
	font[3] = imgui.GetIO().Fonts:AddFontFromFileTTF(u8(sh_legacy_data_path('������', 'SF600.ttf')), 15.0, nil, glyph_ranges)
	
	bold_font[1] = imgui.GetIO().Fonts:AddFontFromFileTTF(u8(sh_legacy_data_path('������', 'SF800.ttf')), 17.0, nil, glyph_ranges)
	bold_font[2] = imgui.GetIO().Fonts:AddFontFromFileTTF(u8(sh_legacy_data_path('������', 'SF800.ttf')), 65.0, nil, glyph_ranges)
	bold_font[3] = imgui.GetIO().Fonts:AddFontFromFileTTF(u8(sh_legacy_data_path('������', 'SF800.ttf')), 35.0, nil, glyph_ranges)
	...
	if image_version_init then
		image_logo_update = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'logo update.png'))
	end
	...
	if #image_radio == 0 then
		image_radio = {
			[1] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'Europa Plus.png')),
			[2] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'DFM.png')),
			[3] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'Chanson.png')),
			[4] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'Dacha.png')),
			[5] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'Road.png')),
			[6] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'Mayak.png')),
			[7] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'Nashe.png')),
			[8] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'LoFi Hip-Hop.png')),
			[9] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'Maximum.png')),
			[10] = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', '90s Eurodance.png'))
		}
	end
end)
...
function autoFixFastActionsIdFlags()
    ...
    local function commandNeedsId(cmd_name)
        ...
        if found_cmd.arg and #found_cmd.arg > 0 then
            ...
            if first_arg then
                ...
                if desc:find('id ������') or desc:find('ID ������') or 
                   desc:find('���� ������') or desc:find('id ������') or
    ...
    if fixed_count > 0 then
        ...
        save()
        if not setting.cef_notif then
            sampAddChatMessage(string.format('[SH]{23E64A} ����������: %d �������� ����������.', fixed_count), 0x23E64A)
        else
            cefnotig(string.format('{23E64A}[SH] ����������: %d �������� ����������.', fixed_count), 3000)
        end
    end
...
function debugCommandInfo(cmd_name)
    ...
    if not found_cmd then
        if not setting.cef_notif then
            sampAddChatMessage('[SH]{FF5345} ������� "' .. cmd_name .. '" �� �������', 0xFF5345)
        else
            cefnotig('{FF5345}[SH] ������� "' .. cmd_name .. '" �� �������', 3000)
        end
        return
    end
    ...
    if has_args then
        for _, arg in ipairs(found_cmd.arg) do
            table.insert(args_info, string.format("%s (%s)", arg.name, arg.type == 1 and "�����" or "�����"))
        end
    end
    
    if not setting.cef_notif then
        sampAddChatMessage(string.format('[SH] ������� "%s": ���������=%s', cmd_name, has_args and table.concat(args_info, ", ") or "���"), 0xFFA500)
    else
        cefnotig(string.format('{FFA500}[SH] ������� "%s": ���������=%s', cmd_name, has_args and table.concat(args_info, ", ") or "���"), 3000)
    end
end
...
function smart_punish_func(arg)
    ...
    if id == nil or not sampIsPlayerConnected(id) then
        if not setting.cef_notif then
            sampAddChatMessage('[SH]{FFFFFF} ' .. '����������� {a8a8a8}/punish [id ������]', 0xFF5345)
        else
            cefnotig('{FF5345}[SH]{FFFFFF} ' .. '����������� {a8a8a8}/punish [id ������]', 2000)
        end
        return
    end
...
function test_punish_func(arg)
	...
	if id == nil or not sampIsPlayerConnected(id) then
		if not setting.cef_notif then
			sampAddChatMessage('[SH]{FFFFFF} ����������� {a8a8a8}/testpunish [id ������]', 0xFF5345)
		else
			cefnotig('{FF5345}[SH]{FFFFFF} ����������� {a8a8a8}/testpunish [id ������]', 2000)
		end
		return
	end
    ...
    if setting.smart_fast_menu then
        ...
        if selectedId then
            ...
            if not smartFastState.selectedPlayer and targetId then
                if not setting.cef_notif then
                    sampAddChatMessage('[SH]{FFFFFF} ����� � ID ' .. selectedId .. ' �� ������ �����.', 0xFF5345)
                else
                    cefnotig('{FF5345}[SH]{FFFFFF} ����� � ID ' .. selectedId .. ' �� ������ �����.', 3000)
                end
                targ_id = nil
            end
        end
        ...
        if not sampIsPlayerConnected(id) then
            if not setting.cef_notif then
                sampAddChatMessage('[SH]{FFFFFF} ����� � ID ' .. id .. ' �� ������.', 0xFF5345)
            else
                cefnotig('{FF5345}[SH]{FFFFFF} ����� � ID ' .. id .. ' �� ������.', 3000)
            end
            targ_id = nil
            return
        end
...
function main()
	...
	local old_cmds_file = sh_legacy_data_path('���������.json')
	...
	if setting.hi_mes then
		if not setting.cef_notif then
			...
			cefnotig('{FF5345}[SH]{FFFFFF} ' .. my.nick:gsub('_',' ') .. ', ��� ��������� �������� ����, ��������� � ��� {a8a8a8}/sh', 4000)
		end
	end
...
function play_song(table_track, loop_track, num_i, song_tab) --> �������� �����
	if song_tab ~= 'RECORD' and song_tab ~= 'RADIO' then
		...
		if cover_link ~= '' and not cover_link:find('no%-cover%-150') then
			download_id = downloadUrlToFile(cover_link, sh_legacy_data_path('�����������', 'Label.png'), function(id, status, p1, p2)
				if status == dlstatus.STATUS_ENDDOWNLOADDATA then
					play.status_image = play.i
					release_music_cover_texture()
					play.image_label = imgui.CreateTextureFromFile(sh_legacy_data_path('�����������', 'Label.png'))
				end
			end)
		else
			play.status_image = play.i
